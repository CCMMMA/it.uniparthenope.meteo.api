...
JSON_GET_CASES = [
    ...
    pytest.param("/api/v1/products", None, lambda data: data["products"] == ["wrf5", "ww33"], id="api-v1-products-list"),
    pytest.param("/api/v1/products/maps", None, lambda data: data["maps"][0]["id"] == "main-map", id="api-v1-products-maps"),
    pytest.param("/api/v1/products/wrf5/maps/themes", None, lambda data: data["themes"][0]["id"] == "wind", id="api-v1-products-themes"),
    pytest.param("/api/v1/products/wrf5", None, lambda data: data["outputs"]["id"] == "wrf5", id="api-v1-products-detail"),
    pytest.param("/api/v1/products/wrf5/outputs", None, lambda data: data["outputs"][0]["id"] == "gen", id="api-v1-products-outputs"),
    pytest.param("/api/v1/products/wrf5/fields", None, lambda data: data["fields"][0]["id"] == "t2c", id="api-v1-products-fields"),
    pytest.param("/api/v1/products/wrf5/com63049/availability", None, lambda data: data["avail"]["available"] is True, id="api-v1-products-availability"),
    pytest.param("/api/v1/products/wrf5/com63049/availability/calendar", None, lambda data: data["events"][0]["title"] == "wrf5 forecast", id="api-v1-products-availability-calendar"),
    ...
    pytest.param("/v2/basemaps", None, lambda data: "satellite" in data, id="v2-basemaps"),
    pytest.param("/v2/basemaps/satellite", None, lambda data: data["id"] == "satellite", id="v2-basemap-detail"),
...
IMAGE_CASES = [
    ...
    pytest.param("/products/wrf5/forecast/legend/right/gen", "image/png", b"legend-image", id="products-legend"),
    pytest.param("/products/wrf5/forecast/legend/right/gen/ncwms", "image/png", b"legend-image-ncwms", id="products-legend-ncwms"),
