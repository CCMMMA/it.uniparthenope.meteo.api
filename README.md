...
- External API v1 consumer guide: [docs/API_CONSUMER_GUIDE.md](docs/API_CONSUMER_GUIDE.md)
- API-key and endpoint access policy: [docs/API_KEY_POLICY.md](docs/API_KEY_POLICY.md)
- API versioning and access governance: [docs/API_GOVERNANCE.md](docs/API_GOVERNANCE.md)
